 ...
 * @ORM\Entity(repositoryClass="Application\Entity\Repositories\UsuarioRepository")
...
class Usuario
{
     ...
     * @var integer
     *
     * @ORM\Column(name="usr_id_persona", type="integer", nullable=true)
     * @Annotation\Type("Zend\Form\Element\Select")
     * @Annotation\Options({
     * "label":"Persona:",
     * "value_options":{ "0":"Select Persona", "1":"Public", "2": "Member"}})
     */
    private $usrIdPersona;
    
    /**
     * @var string
     *
     * @ORM\Column(name="usr_item", type="string", length=10, nullable=true)
     * @Annotation\Attributes({"type":"text"})
     * @Annotation\Options({"label":"Item:"})
     */
    private $usrItem;
     ...
     * @var string
     *
     * @ORM\Column(name="usr_tipo_entidad", type="string", nullable=true)
     */
    private $usrTipoEntidad;
	...
	/**
	 * @return the $usrIdPersona
	 */
	public function getUsrIdPersona() {
		return $this->usrIdPersona;
	}
	
	/**
	 * @param number $usrIdPersona
	 */
	public function setUsrIdPersona($usrIdPersona) {
		$this->usrIdPersona = $usrIdPersona;
	}	
	...
	/**
	 * @param string $usrItem
	 */
	public function setUsrItem($usrItem) {
		$this->usrItem = $usrItem;
	}

	/**
	 * Set usrTipoEntidad
	 *
	 * @param string $usrTipoEntidad
	 * @return Usuario
	 */
	public function setUsrTipoEntidad($usrTipoEntidad)
	{
		$this->usrTipoEntidad = $usrTipoEntidad;
	 ...
	 * @return string
	 */
	public function getUsrTipoEntidad()
	{
		return $this->usrTipoEntidad;
	}	
}