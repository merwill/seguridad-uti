 ...
 */
class UsuarioPerfil extends \Application\Entity\UsuarioPerfil implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setIdUnidad($idUnidad);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'idPerfil', 'estado', 'idUnidad', 'idUsuario');
    }
