 ...
 */
class AplicacionPerfil extends \Application\Entity\AplicacionPerfil implements \Doctrine\ORM\Proxy\Proxy
{	
    ...
    {
        return array('__isInitialized__', 'id', 'idAplicacion', 'idPerfil', 'estado');
    }
